...
})({"fAtmL":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
var _pack3 = require("./packages/pack3");
var _pack2 = require("./packages/pack2");
var _pack1 = require("./packages/pack1");
_pack3.retalappColor({
    color: "verde"
});
_pack2.retalappContainer();
_pack1.retalappShadow({
    shadow_type: "soft",
    padding: true
});

},{"./packages/pack3":"52pST","./packages/pack2":"56Qb5","./packages/pack1":"cIeyv"}],"52pST":[function(require,module,exports) {
function retalappColor(options) {
    let elements = document.querySelectorAll('.color');
    elements.forEach((element)=>{
        if (options.color === "rojo") element.style.backgroundColor = `#C8624C`;
        else if (options.color === "verde") element.style.backgroundColor = `#4CC87B`;
        else if (options.color === "amarillo") element.style.backgroundColor = `#ECE02E`;
        else if (options.color === "azul") element.style.backgroundColor = `#2E7BEC`;
    });
}
module.exports.retalappColor = retalappColor;

},{}],"56Qb5":[function(require,module,exports) {
...
},{}],"cIeyv":[function(require,module,exports) {
...
},{}]},["fAtmL","7BQdY"], "7BQdY", "parcelRequire6577")
